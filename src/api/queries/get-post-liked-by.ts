...
export const getPostLikedByKey = (uid: DID, actor: string, post: string) =>
	['getPostLikes', uid, actor, post] as const;
export const createPostLikedByQuery = (limit: number) => {
	return async (ctx: QueryFunctionContext<ReturnType<typeof getPostLikedByKey>, string>) => {
