...
import { LexicalTypeaheadMenuPlugin, type QueryMatch } from 'lexical-solid/LexicalTypeaheadMenuPlugin';
import { MenuOption } from 'lexical-solid/LexicalTypeaheadMenuPlugin';

import { type BskyProfileBasic, type BskySearchActorTypeaheadResponse } from '~/api/types.ts';
...
class MentionTypeaheadOption extends MenuOption {
	constructor(public data: BskyProfileBasic) {
		super(data.did);
	}
}
...
const MentionsPlugin = (props: MentionsPluginProps) => {
	...
	const [results] = createResource(
		...
		async ([$uid, $query]) => {
			...
			const response = await agent.rpc.get<BskySearchActorTypeaheadResponse>({
