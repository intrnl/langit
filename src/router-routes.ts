...
const routes: RouteDefinition[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "explore/search",
        component: lazy(() => import("./routes/u.$uid.explore.search.tsx")),
        children: [
          {
            path: "posts",
            component: lazy(() => import("./routes/u.$uid.explore.search.posts.tsx")),
          },
          {
            path: "users",
            component: lazy(() => import("./routes/u.$uid.explore.search.users.tsx")),
          },
        ],
      },
      {
