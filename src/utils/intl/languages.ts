const codes = [
	// based off the language clusters in https://bsky.jazco.dev/
	['en', 'eng'], // English
	['pt', 'por'], // Portuguese
	['ja', 'jpn'], // Japanese
	['fa', 'fas'], // Persian
	...
	['zh', 'zho'], // Chinese
	['cu', 'chu'], // Church Slavonic, Old Slavonic, Old Church Slavonic
	['cv', 'chv'], // Chuvash
	['kw', 'cor'], // Cornish
	['co', 'cos'], // Corsican
	['cr', 'cre'], // Cree
...
export const CODE2_TO_CODE3 = Object.fromEntries(codes);
// export const CODE3_TO_CODE2 = Object.fromEntries(codes.map((entry) => [entry[1], entry[0]]));

export const CODE3S = codes.map((entry) => entry[1]);
